...
## Login into MDS
#CA_CERT=./certs/snakeoil-ca-1.crt --ca-cert-path $CA_CERT
CONFLUENT_PLATFORM_USERNAME=professor CONFLUENT_PLATFORM_PASSWORD=professor confluent login --url http://localhost:8090
